...
class TestPricingEngine:
    ...
    @pytest.mark.asyncio
    async def test_volumetric_weight_calculation(self, client):
    ...
    @pytest.mark.asyncio
    async def test_volumetric_weight_less_than_actual(self, client):
    ...
    @pytest.mark.asyncio
    async def test_intra_zone_pricing(self, client):
    ...
    @pytest.mark.asyncio
    async def test_inter_zone_pricing(self, client):
    ...
    @pytest.mark.asyncio
    async def test_cod_surcharge(self, client):
    ...
    @pytest.mark.asyncio
    async def test_prepaid_no_cod(self, client):
    ...
    @pytest.mark.asyncio
    async def test_b2b_vs_b2c_pricing(self, client):
    ...
    @pytest.mark.asyncio
    async def test_weight_boundary_exact_min(self, client):
    ...
    @pytest.mark.asyncio
    async def test_unknown_pincode(self, client):
    ...
    @pytest.mark.asyncio
    async def test_cod_surcharge_min_max(self, client):
    ...
    @pytest.mark.asyncio
    async def test_pricing_quote_includes_zones(self, client):
